            ...
            <div>
                ...
                <div id="bariatric-outputs">
                    <div>
                        ...
                        <label>{this.props.bariatric.startBMI}</label>         
                    </div>    
                    <div>
                        <label className="bariatric-label">Current BMI</label>
                        <label>{this.props.bariatric.currentBMI}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">IBW</label>
                        <label>{this.props.bariatric.IBW}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">EWL</label>
                        <label>{this.props.bariatric.EWL}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">Goal Weight</label>
                        <label>{this.props.bariatric.goalWeight}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">Weight Loss</label>
                        <label>{this.props.bariatric.weightLoss}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">% Weight Loss</label>
                        <label>{this.props.bariatric.percentWeightLoss}</label>                              
                    </div>                                                
                    <div>
                        <label className="bariatric-label">Protein</label>
                        <label>{this.props.bariatric.protein}</label>                              
                    </div>                                                
                </div>                    
            </div>
        );
