...
class Knob extends React.Component {
  ...
  constructor(props) {
    ...
    this.getArcToValue = this.getArcToValue.bind(this);        
    this.getCanvasScale = this.getCanvasScale.bind(this);        
    this.coerceToStep = this.coerceToStep.bind(this);        
    this.eventToValue = this.eventToValue.bind(this);        
    ...
    this.handleTextInput = this.handleEsc.bind(this);        
